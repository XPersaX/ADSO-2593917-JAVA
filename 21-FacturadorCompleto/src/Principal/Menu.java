...
public class Menu extends JFrame {
    ...
    private void initComponents() {
        ...
        btnListarFacturaa = new javax.swing.JButton();
        ...
        btnListarFacturaa.setBackground(new java.awt.Color(0, 0, 153));
        btnListarFacturaa.setFont(new java.awt.Font("Arial", 1, 20)); // NOI18N
        btnListarFacturaa.setForeground(new java.awt.Color(255, 255, 255));
        btnListarFacturaa.setText("LISTAR");
        btnListarFacturaa.setFocusable(false);
        btnListarFacturaa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnListarFacturaaActionPerformed(evt);
            }
        });
        ...
        contentFacturasLayout.setHorizontalGroup(
            ...
            .addGroup(contentFacturasLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnListarFacturaa, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        contentFacturasLayout.setVerticalGroup(
            ...
            .addGroup(contentFacturasLayout.createSequentialGroup()
                ...
                .addGroup(contentFacturasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnListarFacturaa, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnListarFacturaaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarFacturaaActionPerformed
        setVisible(false);
        ListarFacturas ventana = new ListarFacturas(this);
        ventana.setVisible(true);
    }//GEN-LAST:event_btnListarFacturaaActionPerformed

    private void btnEliminarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarClienteActionPerformed
        EliminarUsuarios ventana   = new  EliminarUsuarios (this, this.listaClientes, "CLIENTES");
        ventana.setVisible(true);
        setVisible(false);
    ...
    private void btnEliminarVendedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarVendedorActionPerformed
        EliminarUsuarios ventana   = new  EliminarUsuarios (this, this.listaClientes, "VENDEDORES");
        ventana.setVisible(true);
        setVisible(false);
    ...
    private javax.swing.JButton btnListarFacturaa;
