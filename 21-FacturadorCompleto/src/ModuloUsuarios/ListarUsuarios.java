        ...
        if (listaPersonas!=null) {
            for(int i = 0; i < listaPersonas.length; i++){
                if(listaPersonas[i] != null){
                    etqTemporal = new JLabel(i+1+" - "+listaPersonas[i].getCedula()+" - "+listaPersonas[i].getNombres()+" "+listaPersonas[i].getApellidos()+"-"+listaPersonas[i].getTelefono()+"-"+listaPersonas[i].getDireccion()+"-"+listaPersonas[i].getEmail());
