        ...
        if (listaProductos!=null) {
            for(int i = 0; i < listaProductos.length; i++){
                if(listaProductos[i] != null){
                    etqTemporal = new JLabel(" " + listaProductos[i].getId()+" - "+listaProductos[i].getNombre()+" "+listaProductos[i].getDescripcion()+" - "+listaProductos[i].getPrecio()+" - "+listaProductos[i].getCantidad());
